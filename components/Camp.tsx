    ...
    <section className="2xl:max-container relative flex flex-col py-10 lg:py-20 xl:mb-20">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        <CampSite
         ...
         title='Masa Pmsa Camp'
         subtitle='market, kattilangadi'
         peopleJoined='50+ Joined'/>

         <CampSite
         backgroundImage='bg-bg-img-2'
         title='Language market Camp'
         subtitle='market, kattilangadi'
         peopleJoined='50+ Joined'/>
      </div>
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Starting from the anxiety of the climbers when visiting a new climbing location, the possibility of getting lost is ery large. That's why we are here for those of you who want to start an adventure
          </p>
        </div>
      </div>
    </section>
